...
macro_rules! send_channel_message {
    ($interface:expr, $channel_name:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending message {:?} to channel {:?} at {}:{}:{}", $message, $channel_name, file!(), line!(), column!());
...
macro_rules! send_private_message {
    ($interface:expr, $conversation_id:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending message {:?} to private conversation {:?} at {}:{}:{}", $message, $conversation_id, file!(), line!(), column!());
...
macro_rules! send_private_message_to_user {
    ($interface:expr, $username:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending private message {:?} to user {:?} at {}:{}:{}", $message, $username, file!(), line!(), column!());
...
macro_rules! send_channel_message_advanced {
    ($interface:expr, $channel_name:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending advanced message {:?} to channel {:?} at {}:{}:{}", $message, $channel_name, file!(), line!(), column!());
...
macro_rules! send_private_message_advanced {
    ($interface:expr, $conversation_id:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending advanced message {:?} to private conversation {:?} at {}:{}:{}", $message, $conversation_id, file!(), line!(), column!());
...
macro_rules! send_private_message_to_user_advanced {
    ($interface:expr, $username:expr, $message:expr $(,)?) => {
        {
            tracing::debug!("sending advanced private message {:?} to user {:?} at {}:{}:{}", $message, $username, file!(), line!(), column!());
